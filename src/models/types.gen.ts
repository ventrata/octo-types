...
export type AvailabilityCalendarErrorResponse = OctoAvailabilityCalendarErrorResponse;
...
export type BookingCancellationErrorResponse = OctoBookingCancellationErrorResponse;
...
export type BookingConfirmationErrorResponse = OctoBookingConfirmationErrorResponse;
...
export type BookingReservationErrorResponse = OctoBookingReservationErrorResponse;
...
export type BookingsGetBookingsErrors = {
	 ...
	 */
	400: OctoErrorUnauthorized | OctoErrorInternalServerError | OctoErrorForbidden;
};
...
export type BookingsGetBookingErrors = {
	 ...
	 * The server could not understand the request due to invalid syntax.
	 */
	400: OctoErrorInvalidBookingUuid | OctoErrorUnauthorized | OctoErrorInternalServerError | OctoErrorForbidden;
};
...
export type ProductsGetProductErrors = {
	 ...
	 * The server could not understand the request due to invalid syntax.
	 */
	400: OctoErrorInvalidProductId | OctoErrorUnauthorized | OctoErrorInternalServerError | OctoErrorForbidden;
};
...
export type GetYourGuidePostResponse = GetYourGuidePostResponses[keyof GetYourGuidePostResponses];
...
export type PartnersGetResponse = PartnersGetResponses[keyof PartnersGetResponses];
...
export type WhoIAmSectionGetResponse = WhoIAmSectionGetResponses[keyof WhoIAmSectionGetResponses];
